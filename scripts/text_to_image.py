...
class Txt2Img:
    ...
    def __init__(self, *,
        ...
        sampler_name: is the name of the [sampler](../sampler/index.html)
        n_steps: is the number of sampling steps
        ddim_eta: is the [DDIM sampling](../sampler/ddim.html) $\eta$ constant
        """
    ...
    def __call__(self, *,
        ...
        uncond_scale: is the unconditional guidance scale $s$. This is used for
